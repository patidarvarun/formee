...
import { Pagination, Layout, Calendar, Radio, Card, Typography, Button, Table, Avatar, Row, Col, Input, Select, Progress } from 'antd';
...
class Dashboard extends React.Component {
  ...
  */
  ...
  /**
   * @method renderCalenderMonth 
   * @description render calendar for month 
   */
  renderCalenderMonth = () => {
    const { dates, selectedDate } = this.state
    return (
  ...
  /**
  * @method renderCalenderYear 
  * @description render calendar for Year 
  */
  renderCalenderYear = () => {
    const { dates, selectedDate } = this.state
    return (<Calendar
  ...
  renderCalender = (calendarView) => {
    //  Switch(calendarView)
    //   case 'week':


    // {calendarView === 'week' ?
    // this.renderCalender() : this.renderCalenderMonth()
                      ...
                      >
                        <Row>
                          <Col className='gutter-row' md={24}>
                            {this.renderCalender(calendarView)}
