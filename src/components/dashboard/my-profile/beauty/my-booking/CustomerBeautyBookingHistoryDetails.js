...
import { enableLoading, disableLoading, getBeautyServiceBooking, customerBeautyBookingDispute } from '../../../../../actions';
...
class CustomerBeautyBookingHistoryDetails extends React.Component {
                                ...
                                <div className="body-detail">
                                  <div className="thumb-title-block">
                                    ...
                                    <div className='fm-user-details inner-fourth'>
                                      ...
                                      <Text> </Text>
                                      <Text className='fm-location mt-10'>{bookingResponse.trader_user.business_location ? bookingResponse.trader_user.business_location : ''}</Text>
                                    </div>
                                  </div>
                                </div>
                              </Col>
                                ...
                                <Row gutter={15}>
                                  ...
                                  <Col md={12}>
                                    <div className="title-sub-title-detail">
                                      ...
                                      <div className="sub-title-detail">{bookingResponse.cost}</div>
                                    </div>
                                  </Col>
                                </Row>
...
export default connect(
  mapStateToProps, { enableLoading, disableLoading, getBeautyServiceBooking, customerBeautyBookingDispute }
)(withRouter(CustomerBeautyBookingHistoryDetails));