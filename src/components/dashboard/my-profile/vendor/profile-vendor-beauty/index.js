...
import './profile-vendor-beauty.less';
...
class ProfileVendorBeauty extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
  ...
  render() {
    ...
    return (
      <Layout className="event-booking-profile-wrap fm-beauty-vendor-wrap">
        <Layout>
