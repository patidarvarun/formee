...
export const EditClassForm2 = (props) => {
  ...
  const [editClassData, seteditClassData] = useState({
    className: props.editClassData.class_name,
    instrcutor_name: props.editClassData.instructor_name,
    details: props.editClassData.description,
    room: props.editClassData.room,
    capacity: props.editClassData.capacity,
    price: props.editClassData.price,
    start_date: props.editClassData.start_date,
    end_date: props.editClassData.end_date,
    class_time: props.editClassData.class_time,
  });
  ...
  return (
    <Form
      ...
      initialValues={{
        ...
        class_name: editClassData.className,
        instrcutor_name: editClassData.instrcutor_name,
        description: editClassData.details,
        room: editClassData.room,
        capacity: editClassData.capacity,
        price: editClassData.price,
        class_time: editClassData.class_time,
        start_date: editClassData.start_date,
        end_date: editClassData.end_date,
      }}
    >
                      ...
                      <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                        ...
                        <Row gutter={14}>
                          <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                            ...
                            >
                              <Input placeholder="..." defaultValue={editClassData.className} />
                            </Form.Item>
                          </Col>
                          ...
                          <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                            ...
                            >
                              <Input placeholder="..." defaultValue={editClassData.instrcutor_name} />
                            </Form.Item>
                          </Col>
                        </Row>
                        <Row>
                          <Col span={24}>
                            ...
                            >
                              <TextArea placeholder="..." defaultValue={editClassData.details} />
                            </Form.Item>
                          </Col>
                        </Row>
                        <Row gutter={14}>
                          <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                            <Form.Item
                              ...
                              rules={[required("Room")]}
                            >
                              <Input type={"number"} placeholder="..." defaultValue={editClassData.room} />
                            </Form.Item>
                          </Col>
                          <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                            <Form.Item
                            ...
                            >
                              <Input type="number" placeholder="..." defaultValue={editClassData.capacity} />
                            </Form.Item>
                          </Col>
                        </Row>
                        <Row gutter={14}>
                          <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                            ...
                            >
                              <Input type="number" placeholder="..." defaultValue={editClassData.price} />
                            </Form.Item>
                          </Col>
                          <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                            <Form.Item
                            ...
                            >
                              ...
                              <Select
                                ...
                                size="large"
                                allowClear
                                defaultValue={editClassData.class_time}
                              >
                                 <Option selected>
                                   {editClassData.class_time}
                                  </Option>
                                {durationOption &&
