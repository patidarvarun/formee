...
import { Card, Layout, Typography, Row, Col, Input, Divider, Anchor, Button, Form, Modal, Select } from 'antd';
import { vendorServiceBookingResponse, enableLoading, disableLoading, getBeautyServiceBooking , beautyVendorBookingDispute } from '../../../../../../actions';
...
class VendorBeautyBookingHistoryDetails extends React.Component {
  ...
  onSubmitReportToAdminForm = (values) => {
    ...
    this.props.beautyVendorBookingDispute(reqData, (res) => {
      this.props.disableLoading();
      if (res.status === 200) {
        ...
        this.props.history.push('/beauty-my-bookings');
      }
    });
  }
    ...
    return (
      <Layout>
        <Layout>
          ...
          <Layout>
            <div className='my-profile-box view-class-tab spa-booking-history-detail vendorbeauty-booking-history-detail' style={{ minHeight: 800 }}>
...
export default connect(
  mapStateToProps, { getBeautyServiceBooking, enableLoading, disableLoading, vendorServiceBookingResponse, beautyVendorBookingDispute  }
)(withRouter(VendorBeautyBookingHistoryDetails));