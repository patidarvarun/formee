...
import { Layout, Row, Col, Typography, Carousel, Tabs, Form, Input, Select, Button, Card, Breadcrumb, Table,Tag,Space } from 'antd';
...
const data = [
    {        
        key: '1',
        imagetbl: 'https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png',
        desc:'New York No. 1 Lake Park New York No. 1 Lake Park',
        name: 'John Brown',
        age: 32,
    ...
    },
    {
        key: '2',
        imagetbl: 'https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png',
        desc:'London No. 1 Lake Park London No. 1 Lake Park',
        name: 'Jim Green',
        age: 42,
                    ...
                    <Layout>
                        ...
                        <Layout>
                            <Content className='site-layout'>                               
                                ...
                                <Card
                                    title={<div className='fm-btn-block'>Melbourne
                                                <div className='fm-inner-btn'>
                                                    <Button>Today</Button>
                                                    <Button>This Week</Button>
                                                    <Button>This Weekend</Button>
                                                    <Button className='fm-select-btn'>Next Week</Button>
                                                    <Button>Next Month</Button>
                                                </div>
                                            </div>}
                                    bordered={false}
                                    extra={ <ul className='panel-action'>
                                                <li>
                                ...
                                >                                    
                                    ...
                                    <Row gutter={[40, 40]}>
                                            <Col span={8}>
                                                <h3 className='fm-sub-title'>Popular Sport Events</h3>
                                                    <div className='fm-card-block mb-25'>
                                        ...
                                        <Col span={16} className='fm-list-table'>
