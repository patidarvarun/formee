...
import { enableLoading, disableLoading, updateUserInspectionList } from '../../../../actions'
...
class UpdateInspectionModal extends React.Component {
  ...
  onFinish = (values) => {
    ...
    const requestData = {
      ...
      inspection_id: this.props.selectedInspectionId
    }
    
    this.props.updateUserInspectionList(requestData, res => {
      ...
      >
        <div className='padding'>
          ...
          >
            ...
            <Link className="want-cancel" to="#" onClick={() => {
                    this.props.cancelMyInspection()
                }}>i want to cancel my inspection </Link>
             
              <Button className="btn-orange-fill" type='default' htmlType='submit'>
                Confirm
              </Button>
            </Form.Item>
          </Form>
...
export default connect(mapStateToProps, { updateUserInspectionList, enableLoading, disableLoading })(UpdateInspectionModal);
