...
import { enableLoading, disableLoading, checkPaypalAccepted, getTraderProfile, saveTraderProfile, getUserProfile, changeUserName, changeMobNo } from '../../../../actions';
...
class EditProfile extends React.Component {
  ...
  */
  ...
  saveTraderProfile = () => {
    ...
    const { id } = this.props.userDetails
    const { business_name,business_pincode } = traderProfile.user
    ...
    let reqData = {
      ...
      pincode: step1Data.pincode ? step1Data.pincode : business_pincode !== 'undefined' ? business_pincode : 'Vendor',
              ...
              <div className='card-container signup-tab'>
                <div className='steps-content align-left mt-0'>
                  ...
                  <Card
                    ...
                    bordered={false}
                    title='Profile Setup'
                    extra={<Link className="clr-text" form={'form1'} onClick={() => this.setState({ submitFromOutside: true })} to='#'><Space align={'center'} size={6}>Clear All <Icon icon='delete2' size='11' /></Space></Link>}
                  >
...
export default connect(
  mapStateToProps,
  { enableLoading, disableLoading, checkPaypalAccepted, getTraderProfile, saveTraderProfile, getUserProfile, changeUserName, changeMobNo }
