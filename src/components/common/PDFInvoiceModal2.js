...
import ResDocs from "./pdf/ResDocs";
pdfjs.GlobalWorkerOptions.workerSrc = `//cdnjs.cloudflare.com/ajax/libs/pdf.js/${pdfjs.version}/pdf.worker.js`;

class PDFInvoiceModal2 extends React.Component {
  constructor(props) {
    super(props);
    console.log("VVVVVVVVVVVVV", this.props);
    this.state = {
      toUser: "",
      fromUser: "",
      messageData: "",
      ...
      <Layout>
        ...
        >
          ...
          <ResDocs
            ...
            isViewInvoice={this.props.isViewInvoice ? true : false}
            resDetails={this.props}
          >
